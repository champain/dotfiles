...
# User configuration
export PATH="/opt/puppetlabs/bin:/root/.gem/ruby/2.3.0/bin:/home/jacob/.gem/ruby/2.3.0/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:$PATH"
